...
rect_btn   = pygame.Rect(18, 40, 60, 60)
circle_btn = pygame.Rect(88, 40, 60, 60)
square_btn = pygame.Rect(18, 110, 60, 60)
tri_r_btn  = pygame.Rect(90, 110, 60, 60)
tri_e_btn  = pygame.Rect(19, 180, 60, 60)
rhomb_btn  = pygame.Rect(89, 180, 60, 60)
eraser_btn = pygame.Rect(20, 251, 130, 50)
red_btn    = pygame.Rect(19, 320, 30, 30)
yellow_btn = pygame.Rect(59, 320, 30, 30)
blue_btn   = pygame.Rect(98, 320, 30, 30)
green_btn  = pygame.Rect(140, 321, 30, 30)
